...
def test_parse_term_failure(calculator):
    with pytest.raises(ValueError):
        calculator.parse_interest_rate("abc")
...
def test_calculate_monthly_payment(calculator):
    assert calculator.calculate_monthly_payment(400000, 5, 30, 20000) == pytest.approx(2039.92, 0.01)
...
def test_calculate_total_home_loan_price(calculator):
    assert calculator.calculate_total_home_loan_price(400000, 5, 30, 20000) == pytest.approx(734371.98, 0.01)
...
def test_get_loan_interest(calculator):
    assert calculator.get_loan_interest(400000, 5, 30, 20000) == pytest.approx(354371.98, 0.01)
